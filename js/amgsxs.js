define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'gjp/amgsxs/index' + location.search,
                    add_url: 'gjp/amgsxs/add',
                    edit_url: 'gjp/amgsxs/edit',
                    del_url: 'gjp/amgsxs/del',
                    multi_url: 'gjp/amgsxs/multi',
                    import_url: 'gjp/amgsxs/import',
                    table: 'dg_amgsxs',
                }
            });
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'zz', title: __('Zz'), operate: 'LIKE'},
                        {field: 'ym', title: __('Ym'), operate: 'LIKE'},
