define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'gjp/tdzt/index' + location.search,
                    add_url: 'gjp/tdzt/add',
                    edit_url: 'gjp/tdzt/edit',
                    del_url: 'gjp/tdzt/del',
                    multi_url: 'gjp/tdzt/multi',
                    import_url: 'gjp/tdzt/import',
                    table: 'dg_tdzt',
                }
            });
