define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'gjp/pmzq/index' + location.search,
                    add_url: 'gjp/pmzq/add',
                    edit_url: 'gjp/pmzq/edit',
                    del_url: 'gjp/pmzq/del',
                    multi_url: 'gjp/pmzq/multi',
                    import_url: 'gjp/pmzq/import',
                    table: 'dg_pmzq',
                }
            });
