define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'gjp/jmxc/index' + location.search,
                    add_url: 'gjp/jmxc/add',
                    edit_url: 'gjp/jmxc/edit',
                    del_url: 'gjp/jmxc/del',
                    multi_url: 'gjp/jmxc/multi',
                    import_url: 'gjp/jmxc/import',
                    table: 'dg_jmxc',
                }
            });
