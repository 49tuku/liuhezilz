define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'gjp/qhzt/index' + location.search,
                    add_url: 'gjp/qhzt/add',
                    edit_url: 'gjp/qhzt/edit',
                    del_url: 'gjp/qhzt/del',
                    multi_url: 'gjp/qhzt/multi',
                    import_url: 'gjp/qhzt/import',
                    table: 'dg_qhzt',
                }
            });
