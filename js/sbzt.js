define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'gjp/sbzt/index' + location.search,
                    add_url: 'gjp/sbzt/add',
                    edit_url: 'gjp/sbzt/edit',
                    del_url: 'gjp/sbzt/del',
                    multi_url: 'gjp/sbzt/multi',
                    import_url: 'gjp/sbzt/import',
                    table: 'dg_sbztam',
                }
            });
