define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'gjp/jz3h/index' + location.search,
                    add_url: 'gjp/jz3h/add',
                    edit_url: 'gjp/jz3h/edit',
                    del_url: 'gjp/jz3h/del',
                    multi_url: 'gjp/jz3h/multi',
                    import_url: 'gjp/jz3h/import',
                    table: 'dg_jz3h',
                }
            });
