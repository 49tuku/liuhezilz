define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'gjp/ptjh/index' + location.search,
                    add_url: 'gjp/ptjh/add',
                    edit_url: 'gjp/ptjh/edit',
                    del_url: 'gjp/ptjh/del',
                    multi_url: 'gjp/ptjh/multi',
                    import_url: 'gjp/ptjh/import',
                    table: 'dg_ptjh',
                }
            });
