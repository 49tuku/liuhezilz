define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'gjp/zylx/index' + location.search,
                    add_url: 'gjp/zylx/add',
                    edit_url: 'gjp/zylx/edit',
                    del_url: 'gjp/zylx/del',
                    multi_url: 'gjp/zylx/multi',
                    import_url: 'gjp/zylx/import',
                    table: 'dg_zylx',
                }
            });
