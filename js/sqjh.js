define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'gjp/sqjh/index' + location.search,
                    add_url: 'gjp/sqjh/add',
                    edit_url: 'gjp/sqjh/edit',
                    del_url: 'gjp/sqjh/del',
                    multi_url: 'gjp/sqjh/multi',
                    import_url: 'gjp/sqjh/import',
                    table: 'dg_sqjh',
                }
            });
