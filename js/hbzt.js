define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'gjp/hbzt/index' + location.search,
                    add_url: 'gjp/hbzt/add',
                    edit_url: 'gjp/hbzt/edit',
                    del_url: 'gjp/hbzt/del',
                    multi_url: 'gjp/hbzt/multi',
                    import_url: 'gjp/hbzt/import',
                    table: 'dg_hbzt',
                }
            });
